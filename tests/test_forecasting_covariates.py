...
from microgrid.forecaster import _build_covariates_from_config
...
def test_hehong_example_mpc_weather_forecast_covers_configured_run():
    ...
    cfg = load_profiled_config('examples/mpc.yaml', 'hehong_weather')
...
def test_china_public_holiday_calendar_2026_matches_official_schedule():
    ...
    calendar = pd.read_excel('scenarios/china_public_holiday_calendar_2026.xlsx',
                             sheet_name='calendar')
