...
用法：
  python scripts/backfill_telemetry.py outputs/xxx.xlsx --plant-id hehong_huajin
  python scripts/backfill_telemetry.py outputs/xxx.xlsx --plant-id hehong_huajin --dry-run
  python scripts/backfill_telemetry.py outputs/xxx.xlsx --plant-id hehong_huajin --soc-start 0.5
"""
