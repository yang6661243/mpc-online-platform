"""Load forecasting model trainer — python -m microgrid.forecaster --config forecaster.yaml"""
...
from models.forecasting import LoadForecaster, seasonal_naive_t96, seasonal_naive_t672
...
def main():
    ...
    data_file = _resolve_path(data_cfg.get('file', 'scenarios/train_load.xlsx'))
