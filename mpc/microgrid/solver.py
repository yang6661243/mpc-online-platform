"""MILP optimal solver CLI — python -m mpc.microgrid.solver --config solver.yaml"""
...
from mpc.microgrid.vpp import build_vpp_window_mask, build_workday_average_baseline
